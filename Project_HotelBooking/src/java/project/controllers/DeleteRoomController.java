...
public class DeleteRoomController extends HttpServlet {
    ...
    private final Logger log4j = Logger.getLogger(DeleteRoomController.class);
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (!check) {
                request.setAttribute("DELETE_ERROR", "Delete error at roomID : " + roomID);
            }
        } catch (Exception e) {
            log4j.error("Error at DeleteRoomController : ", e);
        } finally {
