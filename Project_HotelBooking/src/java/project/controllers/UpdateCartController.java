...
public class UpdateCartController extends HttpServlet {
    ...
    private final Logger log4j = Logger.getLogger(UpdateCartController.class);
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            String quantityStr = request.getParameter("txtAmount");
            ...
            if (check) {
                ...
                RoomDTO roomDTO = new RoomDTO(roomID, hotelID, typeID, quantity, price);
            ...
            log4j.error("Error at UpdateCartController : ", e);
        } finally {
