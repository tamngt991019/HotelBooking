 ...
 * @author Kami.Sureiya
 */
public class NextUserController extends HttpServlet {

    private final Logger log4j = Logger.getLogger(NextUserController.class);
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            int maxRow = dao.getNoOfActiveUser(search);
