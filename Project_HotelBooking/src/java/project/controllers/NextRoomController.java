 ...
 * @author Kami.Sureiya
 */
public class NextRoomController extends HttpServlet {

    private final Logger log4j = Logger.getLogger(NextRoomController.class);
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            log4j.error("Error at NextRoomController : ", e);
        } finally {
