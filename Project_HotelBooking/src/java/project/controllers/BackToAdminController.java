 ...
 * @author Kami.Sureiya
 */
public class BackToAdminController extends HttpServlet {

    private final String BACK = "admin.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (session != null) {
                ...
                session.removeAttribute("DAYNUM");

                session.removeAttribute("SEARCH_ROOM_VALUE");
                session.removeAttribute("SEARCH_USER_VALUE");
